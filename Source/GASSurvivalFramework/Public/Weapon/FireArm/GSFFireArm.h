...
class GASSURVIVALFRAMEWORK_API AGSFFireArm : public AGSFWeaponBase
{
    ...
    // 총기 최대 보유 탄약
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Config", meta = (AllowPrivateAccess = true), ReplicatedUsing = OnRep_MaxAmmo)
    int32 MaxAmmo = 30;

    // 총기 현재 보유 탄약
    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "State", meta = (AllowPrivateAccess = true), Transient, ReplicatedUsing = OnRep_CurrentAmmo)
    int32 CurrentAmmo;
    ...
    /* 애니메이션 */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Config|Animation", meta = (AllowPrivateAccess = true))
